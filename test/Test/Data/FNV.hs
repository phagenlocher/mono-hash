...
inputs =
  [ "",
    ...
    mconcat $ replicate 10 "21701",
    mconcat $ replicate 10 "M21701",
    mconcat $ replicate 10 "2^21701-1",
    mconcat $ replicate 10 "\x54\xc5",
    mconcat $ replicate 10 "\xc5\x54",
    mconcat $ replicate 10 "23209",
    mconcat $ replicate 10 "M23209",
    mconcat $ replicate 10 "2^23209-1",
    mconcat $ replicate 10 "\x5a\xa9",
    mconcat $ replicate 10 "\xa9\x5a",
    mconcat $ replicate 10 "391581216093",
    mconcat $ replicate 10 "391581*2^216093-1",
    mconcat $ replicate 10 "\x05\xf9\x9d\x03\x4c\x81",
    mconcat $ replicate 10 "FEDCBA9876543210",
    mconcat $ replicate 10 "\xfe\xdc\xba\x98\x76\x54\x32\x10",
    mconcat $ replicate 10 "EFCDAB8967452301",
    mconcat $ replicate 10 "\xef\xcd\xab\x89\x67\x45\x23\x01",
    mconcat $ replicate 10 "0123456789ABCDEF",
    mconcat $ replicate 10 "\x01\x23\x45\x67\x89\xab\xcd\xef",
    mconcat $ replicate 10 "1032547698BADCFE",
    mconcat $ replicate 10 "\x10\x32\x54\x76\x98\xba\xdc\xfe",
    mconcat $ replicate 500 "\x00",
    mconcat $ replicate 500 "\x07",
    mconcat $ replicate 500 "~",
    mconcat $ replicate 500 "\x7f"
  ]

fnv1VectorsForWord32 :: [Word32]
fnv1VectorsForWord32 =
  [ 0x811c9dc5,
    0x050c5d7e,
    0x050c5d7d,
    0x050c5d7c,
...
fnv1aVectorsForWord32 :: [Word32]
fnv1aVectorsForWord32 =
  [ 0x811c9dc5,
    0xe40c292c,
    0xe70c2de5,
    0xe60c2c52,
...
fnv1VectorsForWord64 :: [Word64]
fnv1VectorsForWord64 =
  [ 0xcbf29ce484222325,
    0xaf63bd4c8601b7be,
    0xaf63bd4c8601b7bd,
    0xaf63bd4c8601b7bc,
...
fnv1aVectorsForWord64 :: [Word64]
fnv1aVectorsForWord64 =
  [ 0xcbf29ce484222325,
    0xaf63dc4c8601ec8c,
    0xaf63df4c8601f1a5,
    0xaf63de4c8601eff2,
